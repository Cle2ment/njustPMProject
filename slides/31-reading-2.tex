...
% --- Reading Q6 ---
\begin{frame}[fragile]{阅读程序 第6题（代码）}{static 局部变量}
...
\begin{frame}{阅读程序 第6题（解析）}{static 局部变量}
    \begin{alertblock}{解析}
        \footnotesize
        \begin{itemize}
...
% --- Reading Q7 ---
\begin{frame}[fragile]{阅读程序 第7题（代码）}{结构体指针传参}
...
\begin{frame}{阅读程序 第7题（解析）}{结构体指针传参}
    \begin{alertblock}{解析}
        \footnotesize myPoint初始 \{x=5, y=12\}：
        \begin{enumerate}
            \setlength{\itemsep}{0pt}
            \item 交换：x↔y → \{12, 5\}
...
% --- Reading Q8-10 (一) ---
\begin{frame}[fragile]{阅读程序 第8-10题（一）代码}{第8空}
...
\begin{frame}{阅读程序 第8-10题（一）解析}{第8空}
    \begin{alertblock}{解析}
        \footnotesize \texttt{func(2, 3)} 计算 $2^3$：
        \begin{itemize}
            \setlength{\itemsep}{0pt}
            \item result = 2
            \item i=1: result *= 2 → 4
...
\begin{frame}[fragile]{阅读程序 第8-10题（二）代码}{第9空}
...
\begin{frame}{阅读程序 第8-10题（二）解析}{第9空}
    \begin{alertblock}{解析}
        \footnotesize
...
\begin{frame}[fragile]{阅读程序 第8-10题（三）代码}{第10空：异或交换}
...
\begin{frame}{阅读程序 第8-10题（三）解析}{第10空：异或交换}
