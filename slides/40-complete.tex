...
% --- Q1: 字符类型判断 ---
\begin{frame}[fragile]{程序完善 第1题（代码）}{字符类型判断}
...
\begin{frame}{程序完善 第1题（答案）}{字符类型判断}
    \begin{alertblock}{答案}
        \footnotesize
        \begin{itemize}
...
% --- Q2: 查找数组元素 ---
\begin{frame}[fragile]{程序完善 第2题（代码）}{数组查找}
    \begin{exampleblock}{题目}
        在a数组中查找与x值相同的元素所在位置。
    \end{exampleblock}
    \begin{lstlisting}[language=C]
...
% --- Q3: 统计非负数 ---
\begin{frame}[fragile]{程序完善 第3题（代码）}{统计非负数}
    \begin{exampleblock}{题目}
