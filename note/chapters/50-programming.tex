...
\vspace{0.5em}
\textbf{步骤\textcircled{1}：边界情况处理（无按钮）}
...
\vspace{0.5em}
\textbf{步骤\textcircled{3}：上行方向 (d == 1)}
...
\vspace{0.5em}
\textbf{步骤\textcircled{4}：下行方向 (d == -1)}
...
\begin{tabular}{@{}p{3cm}p{5cm}p{5cm}@{}}
    ...
    d==1?                  & 是，执行上行分支                    &                                  \\
    find\_larger(\{2,8,10\}, 3, 5) & 遍历: 2>5? no; 8>5?\& 8<IMAX?\newline → min=8; 10>5?\& 10<8? no & 返回 8                        \\
