...
% --- Q3: 合法字面量 ---
\begin{frame}{第3题}{合法字面量 --- 题目}
    \begin{exampleblock}{题目}
        \small 以下不是合法C语言字面量的是 \textbf{【3】} 。
        \begin{itemize}
...
% --- Q6: break / continue ---
\begin{frame}{第6题}{break 与 continue --- 题目}
    \begin{exampleblock}{题目}
        \small 以下正确的描述是 \textbf{【6】} 。
        \begin{itemize}
...
\begin{frame}{第6题}{break 与 continue --- 解析}
    \begin{alertblock}{解析}
        \footnotesize
        \begin{itemize}
            \setlength{\itemsep}{0pt}
...
\begin{frame}{第7题}{逻辑表达式求值 --- 解析}
    \begin{alertblock}{解析}
        \footnotesize 优先级：算术 > 关系 > \&\& > ||
        \begin{itemize}
            \setlength{\itemsep}{0pt}
...
% --- Q8: printf ---
\begin{frame}[fragile]{第8题}{printf 格式化输出 --- 题目}
    \begin{exampleblock}{题目}
...
\end{lstlisting}
    \begin{itemize}
        \item A. A, D \quad B. 65, 68 \quad C. A, 68 \quad D. 65, D
    \end{itemize}
\end{frame}

\begin{frame}{第8题}{printf 格式化输出 --- 解析}
    \begin{alertblock}{解析}
        \small
        \begin{itemize}
...
\begin{frame}{第9题}{字符数组声明 — 题目}
    \begin{exampleblock}{题目}
        \small 下列字符数组的声明正确的是 \textbf{【9】} 。
        \begin{itemize}
...
% --- Q10: 二维数组下标 ---
\begin{frame}{第10题}{二维数组下标越界 --- 题目}
    \begin{exampleblock}{题目}
        \small 若有说明 \texttt{int a[3][4];} 则以下 \textbf{【10】} 表达式不合理。
        \begin{itemize}
            \setlength{\itemsep}{0pt}
...
\begin{frame}{第10题}{二维数组下标越界 --- 解析}
    \begin{alertblock}{解析}
        \footnotesize \texttt{a[3][4]} 的行下标范围 0$\sim$2，列下标范围 0$\sim$3
        \begin{itemize}
            \setlength{\itemsep}{0pt}
