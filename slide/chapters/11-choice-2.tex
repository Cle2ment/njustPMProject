...
% --- Q11: 函数形参 ---
\begin{frame}{第11题}{函数形参 --- 题目}
    \begin{exampleblock}{题目}
        \footnotesize 在C语言的函数中，下列正确的说法是 \textbf{【11】} 。
        \begin{itemize}
...
% --- Q13: 函数嵌套 ---
\begin{frame}{第13题}{函数的定义与调用嵌套 --- 题目}
    \begin{exampleblock}{题目}
        以下正确的描述是 \textbf{【13】} 。
        \begin{itemize}
...
\begin{frame}{第13题}{函数的定义与调用嵌套 --- 解析}
    \begin{alertblock}{解析}
        \footnotesize
        \begin{itemize}
            \setlength{\itemsep}{0pt}
...
\begin{frame}{第14题}{指针下标运算 --- 解析}
    \begin{alertblock}{解析}
        ...
        \begin{center}
            ...
            \texttt{\phantom{a: [1] [2] }\^{}p[-3]\phantom{ [4] [5] }\^{}p}
        \end{center}
...
% --- Q15: union ---
\begin{frame}{第15题}{联合体（union）大小 --- 题目}
    \begin{exampleblock}{题目}
...
\begin{frame}{第15题}{联合体（union）大小 --- 解析}
    \begin{alertblock}{解析}
        \small
        \begin{itemize}
            \setlength{\itemsep}{0pt}
...
% --- Q16: struct 指针 (SPLIT) ---
\begin{frame}[fragile]{第16题 --- 题目}{结构体指针成员访问}
    \begin{exampleblock}{题目}
...
% --- Q17: for循环 ---
\begin{frame}{第17题}{for 循环条件分析 --- 题目}
    \begin{exampleblock}{题目}
...
\begin{frame}{第17题}{for 循环条件分析 --- 解析}
    \begin{alertblock}{解析}
        \footnotesize
...
% --- Q18: static ---
\begin{frame}{第18题}{存储类别 static --- 题目}
    \begin{exampleblock}{题目}
        \footnotesize 在一个C源文件中，若要定义一个只允许本源文件所有函数使用的全局变量，\\
...
\begin{frame}{第18题}{存储类别 static --- 解析}
    \begin{alertblock}{解析}
        \footnotesize
        \begin{itemize}
            \setlength{\itemsep}{0pt}
...
% --- Q19: 指针类型 ---
\begin{frame}{第19题}{字符串指针数组——类型判断 --- 题目}
    \begin{exampleblock}{题目}
        \footnotesize 设有语句：\\
...
\begin{frame}{第19题}{字符串指针数组——类型判断 --- 解析}
    \begin{alertblock}{解析}
        \footnotesize
        \begin{itemize}
            \setlength{\itemsep}{0pt}
