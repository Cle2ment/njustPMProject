...
% --- Reading Q1 代码 ---
\begin{frame}[fragile]{阅读程序 第1题 --- 代码}{for + continue + break}
...
% --- Reading Q1 解析 ---
\begin{frame}{阅读程序 第1题 --- 解析}{for + continue + break}
    \begin{alertblock}{解析}
        \footnotesize
        \begin{itemize}
...
% --- Reading Q2 代码 ---
\begin{frame}[fragile]{阅读程序 第2题 --- 代码}{指针参数}
...
% --- Reading Q2 解析 ---
\begin{frame}{阅读程序 第2题 --- 解析}{指针参数}
    \begin{alertblock}{解析}
        \footnotesize 调用 \texttt{f1(y, \&x)} → \texttt{f1(6, \&x)}
        \begin{itemize}
            \setlength{\itemsep}{0pt}
...
% --- Reading Q3 代码 ---
\begin{frame}[fragile]{阅读程序 第3题 — 代码}{数组反转}
...
% --- Reading Q3 解析 ---
\begin{frame}[fragile]{阅读程序 第3题 — 解析}{数组反转}
    \begin{alertblock}{解析}
        \footnotesize \texttt{f2} 实现\underline{原地反转数组}：
        \begin{itemize}
            \setlength{\itemsep}{0pt}
...
% --- Reading Q4 代码 ---
\begin{frame}[fragile]{阅读程序 第4题 --- 代码}{字符处理}
...
% --- Reading Q4 解析 ---
\begin{frame}{阅读程序 第4题 --- 解析}{字符处理}
    \begin{alertblock}{解析}
        \footnotesize 逐位比较取较大者，转大写（减32）：
        \begin{itemize}
            \setlength{\itemsep}{0pt}
...
% --- Reading Q5 代码 ---
\begin{frame}[fragile]{阅读程序 第5题 — 代码}{递归函数}
...
% --- Reading Q5 解析 ---
\begin{frame}[fragile]{阅读程序 第5题 — 解析}{递归函数}
